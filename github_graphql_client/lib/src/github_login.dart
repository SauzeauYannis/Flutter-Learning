...
class _GithubLoginWidgetState extends State<GithubLoginWidget> {
  ...
  Future<Client> _getOAuth2Client(Uri redirectUrl) async {
    if (widget.githubClientId.isEmpty || widget.githubClientSecret.isEmpty)
      throw const GithubLoginException(
          'githubClientId and githubClientSecret must be not empty. See `lib/github_oauth_credentials.dart` for more detail.');
