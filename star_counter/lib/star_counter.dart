...
class _GitHubStarCounterState extends State<GitHubStarCounter> {
  ...
  void didUpdateWidget(GitHubStarCounter oldWidget) {
    ...
    if (widget.repositoryName == oldWidget.repositoryName) return;
  ...
  Widget build(BuildContext context) {
    ...
    if (errorMessage != null) return Text(errorMessage!, style: errorStyle);

    if (widget.repositoryName.isNotEmpty && repository == null)
      return Text('loading...');

    if (repository == null) return SizedBox();
